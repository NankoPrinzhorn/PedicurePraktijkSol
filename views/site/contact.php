		...
		<div class="container">
			<div class="col-md-12 contactAppointment">
                ...
                <form id="form--right" action="/views/site/mail.php" method="post">
                    ...
                    <input class="firstname" name="firstname" type="text" placeholder="Voornaam" required>
                    <input class="lastname" name="lastname" type="text" placeholder="Achternaam" required>
                    <input class="email" name="email" type="email" placeholder="E-mailadres" required>
                    <textarea class="textarea" name="textarea" cols="50" rows="4" placeholder="Wat wilt u vragen" required></textarea>
                    <div class="col-md-6">
